...
namespace Bam.Net.Data.Repositories.Handlebars
{
    ...
    {
        public HandlebarsSchemaRepositoryGenerator(IDaoRepoGenerationConfig config, ILogger logger = null) : base(SchemaRepositoryGeneratorSettings.FromConfig(config), logger)
        {
